...
#-keep class com.sonnhe.soundrecord.semanticvoiceapplication.service.util.VADManager

-dontwarn cn.thinkit.libtmfe.test.**
-keep class cn.thinkit.libtmfe.test.**{*;}

-dontwarn com.sonnhe.voicecommand.voicelib.**
-keep class com.sonnhe.voicecommand.voicelib.model.**{*;}
-keep class com.sonnhe.voicecommand.voicelib.service.**{*;}
